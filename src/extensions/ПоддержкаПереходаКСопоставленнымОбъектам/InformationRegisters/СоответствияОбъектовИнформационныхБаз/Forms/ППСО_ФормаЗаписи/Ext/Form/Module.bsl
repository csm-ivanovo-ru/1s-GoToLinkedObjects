...
Процедура ПослеВводаНавигационнойСсылкиТекущегоУзла(Результат, Параметры) Экспорт
	...
	Если Не Результат = Неопределено Тогда
		...
		КонецПопытки;
		УникальныйИдентификаторИсточникаПриИзменении(Элементы.УникальныйИдентификаторИсточника);
    КонецЕсли;
...
Процедура ПриИзмененииСопоставленногоОбъекта()
	...
	Попытка
		...
		ЭтотОбъект.НавигационнаяСсылкаПриемника = РаботаСНавигационнымиСсылкамиКлиентСервер.ПолучитьНавигационнуюСсылкуПоРеквизитам(
