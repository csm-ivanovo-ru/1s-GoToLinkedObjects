...
Функция ПолучитьНавигационнуюСсылкуСопоставленногоОбъекта(ОбъектСсылка)
	...
	Если ЗначениеЗаполнено(УзелИнформационнойБазы) Тогда
		НавигационнаяСсылкаПриемника = ПолучитьНавигационнуюСсылкуСопоставленногоОбъектаДляИБ(
				ОбъектСсылка, УзелИнформационнойБазы);
...
&НаСервере
Функция ПолучитьНавигационнуюСсылкуСопоставленногоОбъектаДляИБ(ОбъектСсылка, УзелИнформационнойБазы)
	...
	Если РезультатЗапроса.Пустой() Тогда
		...
		// TODO: Найте решение для определения типа приемника без регистра
	...
	// TODO: Найти решение для хранения моникёра базы. В реквизитах плана обмена?
